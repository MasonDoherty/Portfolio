// import muscleFuelLogo from '../assets/MuscleFuelLogo.png';
...
const data = [
  ...
  //   title: 'Muscle Fuel',
  //   description:
  //     'MuscleFuel is a prominent player in the fitness supplement industry, renowned for crafting personalized workout supplement formulas. This case study explores my role in enhancing the user experience (UX) and user interface (UI) design for MuscleFuels online customization platform.',
  //   image: {
  //     src: muscleFuelLogo,
  //     placeholderSrc: muscleFuelLogo,
  //   },
  //   // links: {
  //   //   site: 'https://assignref.azurewebsites.net/',
  //   // },
